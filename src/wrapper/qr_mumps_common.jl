...
const PICNTL_SYM = (:qrm_ordering, :qrm_minamalg, :qrm_mb, :qrm_nb, :qrm_ib, :qrm_bh, :qrm_keeph, :qrm_rhsnb, :qrm_nlz, :qrm_pinth)
const RCNTL  = ("qrm_amalgth", "qrm_mem_relax", "qrm_rd_eps")
const RCNTL_SYM = (:qrm_amalgth, :qrm_mem_relax, :qrm_rd_eps)
